...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"<i class='ti-angle-double-left'></i>",sLast:"<i class='ti-angle-double-right'></i>",sNext:"<i class='ti-angle-right'></i>",sPrevious:"<i class='ti-angle-left'></i>"},sEmptyTable:"No data available in table",sInfo:"_END_ of _TOTAL_",sInfoEmpty:"0 of 0",
